...
ロゴ画像は元画像の市松模様を削除せず、破れた方眼ノートの切れ端として明るい紙面に配置しています。
...
診断結果の「結果をシェア」は、対応環境ではWeb Share APIを利用します。非対応環境ではX投稿画面を開き、ポップアップを開けない場合は結果テキストをクリップボードへコピーします。共有文にはMY儀式タイプ、今日の運勢、当たり数、4指標、サブコピー、ハッシュタグを含めます。
